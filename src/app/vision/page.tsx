    ...
    <main className="flex min-h-screen flex-col items-center p-8 md:p-16 lg:p-24 bg-[#F5F7FA]"> {/* Light background */}
      <div className="container mx-auto max-w-4xl bg-white p-6 md:p-10 rounded-lg shadow-lg">
        ...
        <section className="mb-12">
          ...
          <div className="text-lg text-[#4A4A4A] font-['Open_Sans'] leading-relaxed space-y-4">
            <p>
              The Global Collective Intelligence Network (GCIN) offers a bold, necessary alternative[cite: 224]. We believe the key to navigating the post-labor transition lies in harnessing the power of collective intelligence—combining the unique strengths of human wisdom, values, and creativity with the analytical and coordinating power of advanced AI[cite: 249, 263, 729].
            </p>
            <p>
              GCIN is building the infrastructure—a new kind of socio-technical operating system—designed for this future. Our approach is rooted in decentralization, transparency, and participation[cite: 663, 907]. We utilize an ecosystem of specialized AI agents not to replace human judgment, but to augment our collective ability to understand complex systems, coordinate large-scale action (like our climate initiative), verify information, and allocate resources effectively and equitably[cite: 266, 913]. We aim to move beyond outdated economic assumptions and build new mechanisms for value creation and distribution fit for the 21st century and beyond[cite: 255, 731].
            </p>
          </div>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-6 md:gap-8 text-center">
            ...
            <div className="p-4 border border-gray-200 rounded-lg shadow-sm">
             ...
             {/* Add Agility, Sustainability if desired, following the pattern */}
          </div>
            {/* --- Icon Prompt --- */}
         ...
         <section className="text-center mt-12 border-t pt-8">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
                 ...
                 <Link
                   ...
                   className="px-8 py-3 bg-[#1A5F7A] text-white font-semibold rounded-md hover:bg-opacity-80 transition-colors font-['Open_Sans']" // Primary Blue
                 >
                   Explore Research
                 </Link>
                 <Link
